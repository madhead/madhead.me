...
[NOTE]
====
You can find many frameworks, along with code examples, in https://core.telegram.org/bots/samples[the dedicated list].
====
...
Then, let's add a logic to **switch the mode**.
